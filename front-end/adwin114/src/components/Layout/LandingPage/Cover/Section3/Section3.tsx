...
export default function Section3() {
    return (
        <section className="m-auto flex flex-col h-screen w-screen snap-start items-center justify-center bg-white text-[#06113C]">      
            <h1
                ...
                <div className="자게">
                    ...
                    <div className='h-full w-full border-2 border-y-[#06113C] border-x-transparent'>
                        ...
                        <FreeBoardCard
                            ...
                            Views={0}
                            Likes={0}
                            thumnailUrl={require("https://s.pstatic.net/static/www/mobile/edit/20220812/mobile_15164273097.png")}/>
                        <hr className="border-[#06113C] opacity-30"/>
                        <FreeBoardCard
                            id={3}
                            title={"이거슨 제목이요"}
