    ...
    return (
        ...
        <nav
            ...
            <div
                ...
                <div
                    className={`mt-[1vh] lg:flex flex-grow items-center` + (
                        navbarOpen
                            ? " flex bg-white/70 lg:bg-transparent"
                            : " hidden"
                    )}>
...
function Item({
    ...
    return (
        <Link
            ...
            className={"flex items-center text-base font-semibold uppercase leading-snug hover:opacity" +
