        ...
        if (window.confirm("제출 하시겠습니까?")) {
            ...
            const fetctPosts = async () => {
                try {
                    ...
                    const response = await axios.post(API_URI, postContents);
...
<> 
    <div className = "bg-[#FFFFFF] justify-center content-center w-screen h-screen overflow-scroll" > 
        <div className="flex flex-col h-[90vh] w-[50vw] sm:mt-[5vh] lg:mt-[8vh] justify-center content-center mx-auto overflow-scroll gap-6">
            ...
            <div className="w-full">
                ...
                onReady={editor => {
                    ...
                    editor.ui.view.editable.element.style.height = "30vh";
                }}
